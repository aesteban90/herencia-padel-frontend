...
export default class FacturasList extends Component{
    ...
    componentDidUpdate(){
        if(this.props.stateTabs.updateListFacturacion){
            this.props.stateTabs.updateListFacturacion = false;
    ...
    groupByProducts(){
        ...
        total_pagar = Math.round(subtotal_iva10incluido + subtotal_iva5incluido + subtotal_excentas);
        //######### Calculando liquidacion IVA ############
        total_iva5 = Math.round(subtotal_iva5incluido - (subtotal_iva5incluido / 1.05));
        total_iva10 = Math.round(subtotal_iva10incluido / 11);
        total_iva = Math.round(total_iva5 + total_iva10);
        ...
        return(            
            <div className="row">
                ...
                <div className="col-md-4">
                    <FacturasForm reserva={this.props.reserva} FacturasListState={this.state}/>
                </div>
            </div>            
        )
    }
