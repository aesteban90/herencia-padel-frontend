...
export default class ProveedorForm extends Component{
    ...
    componentDidUpdate(){        
        if(this.state.idUpdate !== this.props.idUpdate ){
            ...
            if(this.props.idUpdate !== "NEW" && this.props.idUpdate !== "" ){
                axios.get(configData.serverUrl + "/proveedores/"+this.props.idUpdate)
                .then(response => {
                    this.setState({
    ...
    onSubtmit = (e) => {
        ...
        if(this.props.idUpdate === "NEW" || this.props.idUpdate === "" ){
            ...
            axios.post(configData.serverUrl + '/proveedores/add',proveedor)
            ...
            axios.post(configData.serverUrl + '/proveedores/update/'+this.state.idUpdate,proveedor)
                .then(res => this.showNotification(true))
                .catch(err => this.showNotification(false));
        }
